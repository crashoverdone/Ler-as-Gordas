...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tema = QtWidgets.QLabel(self.centralwidget)
        self.tema.setGeometry(QtCore.QRect(170, 10, 451, 16))
        self.tema.setScaledContents(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "ABola"))
        self.titulo.setText(_translate("MainWindow", "TextLabel"))
        self.tema.setText(_translate("MainWindow", "TextLabel"))
        self.hora.setText(_translate("MainWindow", "TextLabel"))
        self.photo.setText(_translate("MainWindow", "TextLabel"))
        self.texto.setText(_translate("MainWindow","TextBox"))
    ...
    def readFile(self):
        with open('abola.csv') as csv_file:
    ...
    def populate(self,noticia):
        ...
        self.hora.setScaledContents(True)
        self.tema.setText(noticia[1])
        self.tema.setScaledContents(True)
        self.titulo.setText(noticia[2])
        self.titulo.setScaledContents(True)
        self.texto.setText(noticia[3])
        self.loadPhoto(noticia[4])
